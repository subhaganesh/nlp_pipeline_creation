...
class DataTransformation:
    ...
    def imbalance_data_cleaning(self):
        ...
        try:
            logging.info("18-Entered into the imbalance_data_cleaning function")
            ...
            #logging.info(f"19-Exited the imbalance data_cleaning function and returned imbalance data {imbalance_data}")
            logging.info("19-Exited the imbalance data_cleaning function and returned imbalance data ")
    ...
    def raw_data_cleaning(self):
        ...
        try:
            logging.info("20-Entered into the raw_data_cleaning function")
            ...
            #logging.info(f"21-Exited the raw_data_cleaning function and returned the raw_data {raw_data}")
            logging.info("21-Exited the raw_data_cleaning function and returned the raw_data ")
            return raw_data
    ...
    def concat_dataframe(self):
        ...
        try:
            logging.info("22-Entered into the concat_dataframe function")
            ...
            logging.info("23-returned the concatinated dataframe")
            return df
    ...
    def concat_data_cleaning(self, words):
        ...
        try:
            logging.info("24-Entered into the concat_data_cleaning function")
            ...
            words=" ".join(words)
            logging.info("25-Exited the concat_data_cleaning function")
            return words 
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifacts:
        try:
            logging.info("17-Entered the initiate_data_transformation method of Data transformation class")
            ...
            logging.info("26-returning the DataTransformationArtifacts")
