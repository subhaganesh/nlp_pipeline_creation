...
class DataIngestion:
    ...
    def get_data_from_mongodb(self) -> None:
        try:
            logging.info("Entered the get_data_from mongodb method of Data ingestion class")
            ...
            logging.info("Exited the get_data_from mongodb method of Data ingestion class")
